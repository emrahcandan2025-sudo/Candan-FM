...
public class MainActivity extends Activity {
    ...
    private void createController() {
        ...
        controllerFuture.addListener(() -> {
            try {
                ...
                Toast.makeText(this, "Servise bağlanılamadı", Toast.LENGTH_SHORT).show();
            }
        }, executor);
    }
    ...
    private void createInterface() {
        ...
        title.setPadding(dp(10), dp(12), dp(10), dp(12));
        ...
        miniParams.setMargins(0, dp(7), 0, dp(12));
        miniPlayer.setLayoutParams(miniParams);

        stationText = new TextView(this);
        stationText.setText("Bir radyo seçin");
        stationText.setTextSize(16);
        ...
        sessionTimeText.setTextSize(12);
        ...
        LinearLayout.LayoutParams side = new LinearLayout.LayoutParams(dp(56), dp(40));
        side.setMargins(dp(10), 0, dp(10), 0);
        previous.setLayoutParams(side);
        next.setLayoutParams(new LinearLayout.LayoutParams(side));

        LinearLayout.LayoutParams middle = new LinearLayout.LayoutParams(dp(64), dp(46));
    ...
    private TextView createControlButton(String symbol, boolean primary) {
        ...
        button.setTextSize(primary ? 22 : 20);
    ...
    private void showRadios(String filter) {
        ...
        for (String[] radio : radios) {
            ...
            createRadioRow(radio[0], radio[2]);
        }
    }

    private void createRadioRow(String name, String letter) {
        boolean isCurrent = false;
        boolean isPlayingCurrent = false;
        ...
        if (controller != null &&
            ...
            isPlayingCurrent = isCurrent && controller.isPlaying();
        }
        ...
        logoBoxBg.setStroke(dp(1.5f), RED);
        ...
        logoImage.setPadding(dp(2), dp(2), dp(2), dp(2));
        ...
        centerParams.setMargins(dp(12), 0, dp(6), 0);
        ...
        if (isPlayingCurrent) {
            ...
            playing.setTypeface(null, Typeface.BOLD);
        ...
        LinearLayout.LayoutParams starParams = new LinearLayout.LayoutParams(dp(44), dp(42));
    ...
    private void playStation(String name) {
        if (controller == null) {
            Toast.makeText(this, "Bağlantı bekleniyor...", Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    private String getLogoUrl(String name) {
        switch (name) {
            case "Süper FM": return "https://mediacdns.karnaval.com/media/station_media/1/logos/meta_image.png";
            case "Metro FM": return "https://mediacdns.karnaval.com/media/station_media/2/logos/meta_image.png";
            case "JoyTürk": return "https://mediacdns.karnaval.com/media/album_media/41616/albumcover_400x400/cover_41616.jpg";
            case "Joy FM": return "https://mediacdns.karnaval.com/media/station_media/3/logos/meta_image.png";
            case "Virgin Radio": return "https://pbs.twimg.com/profile_images/1125687465266831362/9DtDhuas.png";
            case "Kral Pop": return "https://static-media.streema.com/media/cache/fb/f8/fbf853d0e2981fbf40d4503bb537ba63.png";
            case "Kral FM": return "https://www.dogusgrubu.com.tr/DogusGrubu_Files/202012713129787_kral-fm-logo-01.jpg";
            case "Power FM": return "https://cdn-profiles.tunein.com/s14259/images/logog.png";
            case "PowerTürk":
            case "Power Pop": return "https://www.google.com/s2/favicons?domain=powerapp.com.tr&sz=256";
            case "Alem FM": return "https://www.google.com/s2/favicons?domain=alemfm.com.tr&sz=256";
            case "Radyo Spor": return "https://www.google.com/s2/favicons?domain=radyospor.com&sz=256";
            case "Kafa Radyo": return "https://ik.fskit.net/radyohome/media/station/105/logo_square.png";
            case "Radyo Fenomen": return "https://cdn.radyofenomen.com/artwork/logo20.png";
            case "Radyo 45lik": return "https://www.google.com/s2/favicons?domain=radyo45lik.com&sz=256";
            case "SlowTürk": return "https://www.google.com/s2/favicons?domain=slowturk.com.tr&sz=256";
            case "Best FM": return "https://static-media.streema.com/media/cache/9e/fa/9efa50eb77fd19631846e03fbbed543b.png";
            case "TRT FM":
            case "TRT Radyo 1":
            case "TRT Türkü":
            case "TRT Nağme": return "https://www.google.com/s2/favicons?domain=trt.net.tr&sz=256";
            case "A Haber Radyo": return "https://www.google.com/s2/favicons?domain=ahaber.com.tr&sz=256";
            case "A Spor Radyo": return "https://www.google.com/s2/favicons?domain=aspor.com.tr&sz=256";
            case "Radyo Turkuvaz": return "https://www.google.com/s2/favicons?domain=radyoturkuvaz.com.tr&sz=256";
            case "Lig Radyo": return "https://www.google.com/s2/favicons?domain=ligradyo.com.tr&sz=256";
            case "Radyo Voyage": return "https://www.google.com/s2/favicons?domain=radyovoyage.com&sz=256";
            default: return "";
        }
    }
